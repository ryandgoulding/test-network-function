...
In order to run a operator test suite, `operator-test` for example, issue the following command:
...
You can either edit existing config at `test-network-function/operator-test/config/config.yml`
